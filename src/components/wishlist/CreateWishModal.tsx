...
export default function CreateWishModal({
  ...
  return (
    <S.ModalContainer style={S.ModalContainerOverrides}>
      <S.Header>
        <S.Title>{t("shopping_wishlist:wishlist.add_item", "Додати бажання")}</S.Title>
      </S.Header>

      <S.Content>
        <S.Form onSubmit={handleSubmit} id="create-wish-form">
          ...
          <S.FieldGroup>
            ...
            <Input
              autoFocus
              required
              placeholder="Наприклад: AirPods Pro"
              value={state.name}
          ...
          <S.FieldGroup>
            <S.Label>{t("shopping_wishlist:wishlist.link", "URL (необов'язково)")}</S.Label>
            <Input
              type="url"
              placeholder="https://..."
              value={state.url}
